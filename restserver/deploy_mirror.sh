...
# aws elasticbeanstalk describe-application-versions --application-name cs3300-mirror --output=json --profile cs3300
...
aws elasticbeanstalk update-environment --environment-name cs3300-mirror --version-label $VERSION --profile cs3300

echo "##### Done."
echo "## Check status using:  aws elasticbeanstalk describe-environments --environment-name cs3300-mirror --profile cs3300" 
